...
var HeroSearchComponent = (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTerms
            .debounceTime(300) //wait 300ms after each key stroke before considering the item
            .distinctUntilChanged() //ignore if next search term is the same as previous
            .switchMap(function (term) { return term //swithc to new observable each time the term changes
